<template>
  <div
      class="top-0 right-0 left-0 w-full z-50"
  >
    <div
        class="bg-[#0F172A] flex relative">
      <div
        ...
        <button class="block min-[768px]:hidden h-fit w-fit" @click="handleShowMenu">
          <img v-if="!showMenu" src="../assets/images/menu-btn.png" alt="" width="32">
          <img v-else src="../assets/images/btn-close.png" alt="">
        </button>

      </div>
      <div
          :class="{'show':showMenu}"
          class="flex flex-col absolute right-0 left-0 bottom-0 top-[60px] bg-[#0F172A] h-[100vh]
      ...
      <div
        ...
        <div
            :class="{'popupShow':showPopup}"
            class="flex justify-center items-center bg-[#0F172A] p-[30px] rounded-[12px] flex-col w-[400px] gap-[10px] popup ">
          <button class="self-end" @click="handlePopup">
            <img src="../assets/images/btn-close.png" alt="" width="24px">
          </button>
  ...
  <div
      :class="{'!h-auto': showHeader, '!opacity-100': showHeader}"
